                ...
                <table class="form-layout-compressed" style="margin-top: -0.5em;">
                    <tr>
                        ...
                        {if $element.html_type eq 'Radio'}
                            <td><span class="crm-clear-link">(<a href="#" title="unselect" onclick="unselectRadio('{$element_name}', '{$form.formName}'); return false;" >{ts}Clear {$form.$element_name.label|@strip_tags} {/ts}</a>)</span></td>
                        {/if}
                    </tr>
                </table>
            </td>
    ...
    {else}
        <tr class="custom_field-row {$element.element_name}-row">
            ...
            <td class="html-adjust">
                ...
                {if $element.html_type eq 'Radio'}
                    <span class="crm-clear-link">(<a href="#" title="unselect" onclick="unselectRadio('{$element_name}', '{$form.formName}'); return false;" >{ts}Clear {$form.$element_name.label|@strip_tags}{/ts}</a>)</span> 
