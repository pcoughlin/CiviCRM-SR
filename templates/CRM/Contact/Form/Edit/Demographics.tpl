...
<div class="crm-accordion-wrapper crm-demographics-accordion crm-accordion-closed">
 <div class="crm-accordion-header">
  ...
  <div class="form-item">
	...
	<span class="value">
        {$form.gender_id.html}
        <span class="crm-clear-link">(<a href="#" title="unselect" onclick="unselectRadio('gender_id', '{$form.formName}'); return false;">{ts}Clear {$form.gender_id.label|@strip_tags}{/ts}</a>)</span>
        </span>
  </div>
  <div class="form-item">
